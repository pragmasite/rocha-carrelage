...
const DisclaimerModal = () => {
  ...
  useEffect(() => {
    // Check if disclaimer has been dismissed in session storage
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={{ scale: 0.9, y: 20 }}
            className="w-full max-w-md rounded-2xl bg-background p-8 shadow-medium border border-border/50"
          >
